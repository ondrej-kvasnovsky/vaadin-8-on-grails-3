...
In this step you will make it possible to run Grails from your command line. Select *Path* variable from list of system variables and click on *Edit...* button. Go at the end of text in *Variable value* text field and add ```C:\grails-3.1.7\bin```
